# **PhotoShop Activation Script | No Crack**

An open-source tool to activate and reset the trial of [Adobe PhotoShop](https://www.adobe.com/products/photoshop.html)
...
# Features
* PhotoShop freeze trial and activation with registry key lock method
...
First fresh install [PhotoShop](https://www.adobe.com/products/photoshop.html). Make sure previous cracks/patches are removed/uninstalled if there are any.
...
## Reset PhotoShop Activation / Trial
